      ...
      useEffect(() => {
        const calculateCartTotals = () => {
          ...
          const discountPercent =
            subtotalMRP > 0
              ? ((discountAmount / subtotalMRP) * 100).toFixed(2)
              : 0;
        setTotals({subtotalMRP,
            subtotalSelling,
            discountAmount,
            discountPercent,
            ...
            <div className={styles.cartWrapper}>
              {isLoading ? (
                ...
                <div className={styles.noItemCtn}>
                  <span className={styles.noItemText}>
                ...
                <div className={styles.cartItems}>
                  {lineItems.map((item, index) => (
                    <div className={clsx(styles.itemCard)} key={index}>
              ...
              <div className={styles.orderSummary}>
                ...
                <div className={styles.billingCtn}>
                  <div className={styles.pricingBreakdownCtn}>
                    ...
                    <div
                      className={clsx(styles.pricingRow, styles.discountCtn)}
                    >
                      <span className={styles.chargeLabel}>
