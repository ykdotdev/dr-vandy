    ...
    <div className={styles.mainCtn}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <p>
          ...
          and long-term wellness are deeply connected. Her mission is simple: to
          make{" "}
          <strong>
        ...
        <p>
          ...
          elderly individuals managing mobility and age-related concerns. These
          real-world clinical interactions shape how we think, what we
        ...
        <p>
          ...
          from a child’s development, a woman’s wellness journey, or an elderly
          individual’s mobility challenges.
        </p>

        <p>
          Our goal is to build thoughtful, clinically guided solutions across
          every life stage — grounded in professional physiotherapy experience,
          research-driven formulation, and a deep understanding of real human
          needs.
        </p>
